...
" window. They also do not work on Mac OS X using iTerm2 with the non-ASCII settings defined correctly.
" I was not able to find any help in documentation or reported issues.
